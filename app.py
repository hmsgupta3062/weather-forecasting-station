...
def temperature_data_func():
    ...
    streamlit.write('')
    streamlit.write(data_source.loc[:, ['created_at', 'field1', 'field3']].astype(str))
    streamlit.write('')
    streamlit.write('')
    streamlit.subheader('Exploring Processed ' + data_name.title() + ' Data')
    streamlit.write('')
    streamlit.write(processed_data_source.loc[:, ['timestamp', data_name]])
    streamlit.write('')
    streamlit.write('')
    streamlit.subheader('Visualising Data')
    streamlit.write('')
    streamlit.info('' + data_name.title() + ' (in DegC) vs Timestamp')
    streamlit.write('')
    ...
    streamlit.info('' + data_name.title() + ' (in DegC) vs Future Timestamp values')
    streamlit.write('')
    draw_line_plot(plot_forecast_data)

def humidity_data_func():
    global processed_data_source, plot_data_source
    data_name = 'humidity'
    ...
    streamlit.subheader('Exploring Raw ' + data_name.title() + ' Data')
    streamlit.write('')
    streamlit.write(data_source.loc[:, ['created_at', 'field2', 'field4']].astype(str))
    streamlit.write('')
    streamlit.write('')
    streamlit.subheader('Exploring Processed ' + data_name.title() + ' Data')
    streamlit.write('')
    ...
    streamlit.subheader('Visualising Data')
    streamlit.write('')
    streamlit.info('' + data_name.title() + ' (in %) vs Timestamp')
    streamlit.write('')
    draw_line_plot(plot_data_source[data_name])
    streamlit.write('')
    streamlit.write('')
    ...
    streamlit.write('')
    plot_forecast_data = process_plot_data(forecast_data)
    streamlit.info('' + data_name.title() + ' (in %) vs Future Timestamp values')
    streamlit.write('')
    draw_line_plot(plot_forecast_data)

def pressure_data_func():
    global processed_data_source, plot_data_source
    data_name = 'pressure'
    ...
    streamlit.subheader('Exploring Raw ' + data_name.title() + ' Data')
    streamlit.write('')
    streamlit.write(data_source.loc[:, ['created_at', 'field5']].astype(str))
    streamlit.write('')
    streamlit.write('')
    streamlit.subheader('Exploring Processed ' + data_name.title() + ' Data')
    streamlit.write('')
    ...
    streamlit.subheader('Visualising Data')
    streamlit.write('')
    streamlit.info('' + data_name.title() + ' (in Pa) vs Timestamp')
    streamlit.write('')
    draw_line_plot(plot_data_source[data_name])
    streamlit.write('')
    streamlit.write('')
